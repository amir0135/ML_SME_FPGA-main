...
namespace mulmin_sig
{
    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            using (var sim = new Simulation())
            {
                ...
                var array_sigmoid = new SME.Components.SimpleDualPortMemory<float>((int)Deflib.Parameters.num_networks, sig_flat);
    ...
    public class minmul_Stage
    {
        ...
        public minmul_Stage(IndexControl testcontrol, IndexControl control_in, SME.Components.SimpleDualPortMemory<float> ram_in)
        {

    ...
    class MainClass{
        public static void Main(string[] args)
        {
            using (var sim = new Simulation())
            {
                ...
                //var matmul_flat = Deflib.Functions.Flatten(matmul_data);
                
                //putting iN array
                var array_matmul = new SME.Components.SimpleDualPortMemory<double>((int)Deflib.Parameters.num_networks* (int)Deflib.Parameters.hidden_size,Deflib.Functions.Flatten(matmul_data));  
                var array_prelu_z = new SME.Components.SimpleDualPortMemory<double>((int)Deflib.Parameters.num_networks, Deflib.data.prelu_z_slopes); 
                ...
                //putting iN array
                var array_prelu_r = new SME.Components.SimpleDualPortMemory<double>((int)Deflib.Parameters.num_networks, Deflib.data.prelu_r_slopes); 
        ...
        public class HzStage{
            ...
            public HzStage(IndexControl testcontrol, IndexControl controlA_in, IndexControl controlB_in,   SME.Components.SimpleDualPortMemory<double> ramA_in, SME.Components.SimpleDualPortMemory<double> ramB_in ){
